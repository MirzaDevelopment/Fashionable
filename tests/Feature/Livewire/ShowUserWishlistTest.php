<?php
/*
Livewire tests that tests the ShowUsersWishlist livewire component. The component is responsible for rendering and deleting wishlisted items. All is tested here
*/
...
class ShowUserWishlistTest extends TestCase
{
    ...
    public function test_user_can_view_his_wishlist()
    {
        ...
        /** @test */
    public function test_user_can_delete_his_wishlist()
    {
        $user = User::factory()->create();
        //Creating fake variables
        $fakeProduct = Product::factory()->create(['product_name' => 'Test Name', 'description' => 'Test description', 'total_stock' => 0]);
        ...
        Livewire::actingAs($user)->test(ShowUserWishlist::class)->call("deleteWishlistItem",$fakeProduct->id)->assertHasNoErrors();
