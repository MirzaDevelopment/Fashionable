<!--Deleted products view component-->
<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg text-center">
                <div class="p-6 text-gray-900">
                    <p class="mb-2 text-base">{{ __("Obrisani proizvodi") }}</p>
                    <p class="text-sm">Ovdje možete vratiti obrisane proizvode.</p>
    ...
    <!--Livewire component for showing deleted users in db-->
    <livewire:show-deleted-products />
    <div class="pb-12">
