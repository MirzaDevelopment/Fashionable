      ...
      <div id="carouselItem" class="lg:flex gap-[1rem] flex flex-col xl:flex-row place-content-evenly items-center min-w-[100%] snap-start rounded-xl overflow-hidden bg-white shadow-md  p-[1rem] rounded-lg  transform transition duration-300">
        ...
        <div class="flex flex-col  gap-[1rem] xl:p-12 items-center min-w-[100%] lg:min-w-fit lg:w-[100%]">
          ...
          <div class="relative transition-all duration-300 group relative">
            ...
            <button aria-label="Name" wire:key="{{$index}}" wire:click="wishListItem({{$product->id}})"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="black" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
