    ...
    <div class="min-h-screen bg-gradient-to-br from-white via-slate-50 to-blue-50"> <!-- Frontend livewire component for tenant registration -->
        ...
        <section wire:key="step-2" class="sm:p-6 mt-10 sm:max-w-[80%] xl:max-w-[50%] w-fit m-auto place-content-evenly bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col">
            <div class="m-auto flex flex-col gap-y-6 p-8">
                ...
                @error('user_name')
                <!-- Validation failed message -->
                <span class="error text-[#D32F2F] mt-1 sm:max-w-[80%] xl:max-w-[50%] m-auto">{{ $message }}</span>
                @enderror
                ...
                @error('policy')
                <!-- Validation failed message -->
                <span class="error text-[#D32F2F] mt-1 col-start-2 sm:max-w-[80%] xl:max-w-[50%] m-auto">{{ $message }}</span>
                @enderror
            </div>
