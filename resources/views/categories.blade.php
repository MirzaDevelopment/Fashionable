        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg text-center">
                <div class="p-6 text-gray-900">
                    <p class="mb-2 text-base">{{ __("Upravljanje kategorijama") }}</p>
                    <p class="text-sm">Ovdje se nalaze sve kategorije koje možete pridružiti vašem proizvodu</p>
                    <p class="text-sm" >Molimo da se po potrebi konsultujete sa vodičem za kategorije dostupnim <a href="/#footer" class="underline text-cornflowerblue">ovdje</a></p>
                </div>
            </div>
        </div>
    </div>
