<x-front-layout><!--First product page (after welcome.blade.php) view with the front.blade structure component in layouts folder-->
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-[1rem] overflow-hidden">
        <div class="relative flex 2xl:group relative transition-all duration-300 ease-in-out transform 2xl:hover:scale-105 ">
            <picture class="w-fit row-start-2 h-auto">
                ...
                <img class="col-span-1 shadow-[0_8px_30px_rgba(0,0,0,0.12)] row-start-2 brightness-[70%] w-full  h-auto" fetchpriority="high" loading="eager" src="{{ asset('storage/images/200x200/shop_male_200x300.webp') }}" width="320"height="480" alt="men_models">
            </picture>
            <!--Navigation towards search and category-->
            <span class="absolute text-[calc(5rem+3vw)] sm:text-[5rem] md:text-[calc(6rem+2vw)] lg:text-[calc(8rem+2vw)] xl:text-[calc(10rem+1vw)] 2xl:text-[12rem] lg2:text-[15rem] text-white"><a href="/shop#explore">Istraži</a></span>
        </div>
        <div class="relative flex 2xl:group relative transition-all 2xl:duration-300 ease-in-out transform 2xl:hover:scale-105 ">
            ...
            <span class="absolute text-[calc(5rem+2vw)] sm:text-[5rem] md:text-[calc(6rem+2vw)] lg:text-[calc(8rem+2vw)] xl:text-[calc(10rem+1vw)] 2xl:text-[12rem] lg2:text-[15rem] text-white"><a href="/shop#special-prices">Akcijske cijene</a></span>
        </div>
    </div>
    ...
    <div class="relative flex items-end z-[-10]">
        ...
        <span style="font-family: 'Playfair Display', serif; font-weight: 500; color: white;" class="absolute p-[1rem] text-[1rem] sm:text-[calc(1rem+2vw)] lg2:text-[3.5rem] text-white">Na <strong>Melisa Fashion</strong> pretvaramo snove u stil koji možete nositi. Vođeni kreativnošću i strašću, dizajniramo modu koja osnažuje samopouzdanje i slavi individualnost.

            Snove koje možete nositi.

            <em>- Mirza Mehagić
                CEO, Melisa Fashion</em>
    </div>
